...
const en = {
  ...
  seo: {
    ...
    poemDescription: (matla: string, title: string) => `${matla}: ${title}, an Urdu ghazal by Saeedi (Mohammad Saeed Saeedi), in full in Urdu and Roman Urdu.`,
    ghazal: 'Urdu ghazal',
  },
  nav: {
    home: 'Home',
  ...
  kalaam: {
    ...
    search: 'Search in Urdu or Roman Urdu',
